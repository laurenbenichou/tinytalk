 ...
 */
 ...
 (function(d,e){var c,b;d.uaMatch=function(a){a=a.toLowerCase();var b=/(chrome)[ \/]([\w.]+)/.exec(a)||/(webkit)[ \/]([\w.]+)/.exec(a)||/(opera)(?:.*version|)[ \/]([\w.]+)/.exec(a)||/(msie) ([\w.]+)/.exec(a)||0>a.indexOf("compatible")&&/(mozilla)(?:.*? rv:([\w.]+)|)/.exec(a)||[];a=/(ipad)/.exec(a)||/(iphone)/.exec(a)||/(android)/.exec(a)||[];return{browser:b[1]||"",version:b[2]||"0",platform:a[0]||""}};c=d.uaMatch(e.navigator.userAgent);b={};c.browser&&(b[c.browser]=!0,b.version=c.version);c.platform&& (b[c.platform]=!0);b.chrome?b.webkit=!0:b.webkit&&(b.safari=!0);d.browser=b})(jQuery,window);
...
(function(c){c.extend(c.infinitescroll.prototype,{_setup_twitter:function(){var a=this;c(this.options.nextSelector).click(function(b){1==b.which&&(!b.metaKey&&!b.shiftKey)&&(b.preventDefault(),a.retrieve())});a.options.loading.start=function(b){b.loading.msg.appendTo(b.loading.selector).show(b.loading.speed,function(){a.beginAjax(b)})}},_showdonemsg_twitter:function(){var a=this.options;a.loading.msg.find("img").hide().parent().find("div").html(a.loading.finishedMsg).animate({opacity:1},2E3,function(){c(this).parent().fadeOut("normal")}); c(a.navSelector).fadeOut("normal");a.errorCallback.call(c(a.contentSelector)[0],"done")}})})(jQuery);
